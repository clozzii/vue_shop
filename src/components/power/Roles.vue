<template>
  <div>
            ...
            <el-row :class="['bdbottom', i1 === 0 ? 'bdtop' : '', 'vcenter']" v-for="(item1, i1) in scope.row.children"
              ...
              <el-col :span="19">
                ...
                <el-row v-for="(item2, i2) in item1.children" :key="item2.id"
                  ...
                  <el-col :span="18">
                    <el-tag @close="removeRightById(scope.row, item3.id)" closable v-for="(item3, i3) in item2.children"
    ...
    <el-dialog title="分配权限" :visible.sync="setRightDialogVisible" width="50%" @close="setRightDialogClosed">
      <!-- 树形控件 -->
      <el-tree :data="rightslist" :props="treeProps" ref="treeRef" @node-click="handleNodeClick() " show-checkbox
